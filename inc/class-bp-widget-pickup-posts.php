<?php
/**
 * Widget API: BP_Widget_Pickup_Posts class
 *
 ...
 * @see WP_Widget
 */
class BP_Widget_Pickup_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname' => 'bp_widget_pickup_entries',
			'description' => __( 'Your site&#8217;s most pickup Posts.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'bp-pickup-posts', __( 'Pickup Posts with Thumbnail' ), $widget_ops );
		$this->alt_option_name = 'bp_widget_pickup_entries';
	}
